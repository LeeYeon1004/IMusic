...
const app  = {
    ...
    songs: [
        ...
        },
        {
            ...
            single: 'Justin ft. Big Sean',
            image: './assets/image/As_Long_As_You_Love_Me_(feat._Big_Sean)_-_Single.jpg',
            music: './assets/music/aslongas.mp3'
        },
        {
            name: 'That Girl',
    ...
    render: function(){
        const lists = this.songs.map((song, index) => {
                return `
                <tr class="song ${index === app.currentIndex ? 'option' : ''}" data-index="${index}">
